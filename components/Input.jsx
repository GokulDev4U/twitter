    ...
    return (
        <div className={`border-b border-gray-700 p-3 flex space-x-3 overflow-y-scroll`}>
            ...
            <div className='w-full divide-y divide-gray-700'>
                ...
                <div className={``}>
                    <textarea value={input} onChange={(e)=>setInput(e.target.value)} row="2" className="bg-transparent outline-none text-[#d9d9d9] text-lg placeholder-gray-500 tracking-wide w-full min-h-[50px]" placeholder="What's happening"/>
                        {selectedFile && (
